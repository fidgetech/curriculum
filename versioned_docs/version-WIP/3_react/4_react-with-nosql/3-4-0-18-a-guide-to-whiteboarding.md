---
title: "📓 3.4.0.18 A Guide to Whiteboarding"
day: weekend
id: 3-4-0-18-a-guide-to-whiteboarding
...
This is a more advanced step and you are not required to optimize your code for your technical interview. However, as you get more experience, you should look for ways to optimize your whiteboard code. For instance, there are many ways to sort an array and some are more efficient than others. If you used a brute force solution to sort an array, you might want to try implementing a [merge sort](https://en.wikipedia.org/wiki/Merge_sort) - or at least tell your interviewers about it.

## Whiteboarding Remotely

Because Fidgetech is a fully virtual program, your whiteboard session will happen remotely. Instead of writing on a physical whiteboard, you'll share your screen and type your solution in a text editor. Some employers run their whiteboard sessions this way, and many others "whiteboard" using a computer even when everyone is in the same room, so practicing with a text editor is good preparation either way.

When you share your screen for a remote session, you'll need to consider the following points:

---
title: "\U0001F4D3 Practicing the Git Workflow"
...
![Click on the pencil icon to make an update to the code.](/Intermediate+JavaScript/click-pencil-icon.png)
...
![Image shows the merge conflict in VS Code.](/Intermediate+JavaScript/merge-conflict.png)

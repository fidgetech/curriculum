---
title: "📓 3.4.1.4 Building a React Application with Redux From Scratch"
day: monday
id: 3-4-1-4-building-a-react-application-with-redux-from-scratch
...
Only now are we ready to add Redux to the application. You can follow along with this Help Queue lesson again to walk through each step: [React with Redux: Adding Redux to React: Part 2](../../react/react-with-redux/4-3-0-12-adding-redux-to-react-part-2). Also, don't forget to install react and react-redux if they aren't already in your `package.json` file:

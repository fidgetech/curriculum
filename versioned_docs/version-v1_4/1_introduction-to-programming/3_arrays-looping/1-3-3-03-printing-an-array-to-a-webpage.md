...
![This image shows the result of printing the 3 arrays `numAr`, `stringAr`, and `morePrimitives` to the webpage.](/images/INTRO/week3-branching-looping-arrays/printing-array-to-page.png)
...
![This image shows the result of calling `Array.prototype.join()` on `numAr`, `stringAr` and `morePrimitives` and printing that result to the webpage.](/images/INTRO/week3-branching-looping-arrays/using-array-join-method.png)
...
![This image shows the result of trying to print objects to the webpage.](/images/INTRO/week3-branching-looping-arrays/printing-array-of-objects.png)

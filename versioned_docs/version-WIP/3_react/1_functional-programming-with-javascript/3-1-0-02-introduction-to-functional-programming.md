...
With object-oriented programming we built objects that store information and have methods attached to them. Object-oriented programming relies on techniques like **inheritance** and **encapsulation**. Functional programming is a different paradigm.
...
In pure functional programming, the goal is to write **stateless** functions - functions that don't rely on or modify data outside themselves. Instead of storing information in objects or global variables, we pass data between functions.
```js
...
This makes code more predictable and easier to debug. We'll explore this concept of **immutability** more in upcoming lessons.

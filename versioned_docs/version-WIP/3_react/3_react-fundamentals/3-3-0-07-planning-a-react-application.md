---
title: "📓 3.3.0.7 Planning a React Application"
day: weekend
id: 3-3-0-7-planning-a-react-application
...
In the React documentation, there is an article called [Thinking in React](https://react.dev/learn/thinking-in-react) that outlines the process of planning, building out a static site, and then finally adding state. We recommend taking a quick look at the steps in that article before continuing. We will be following the same process as we build out our Help Queue application.

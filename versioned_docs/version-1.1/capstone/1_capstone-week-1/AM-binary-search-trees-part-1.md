...
![Image of adding a child node to the root node and then adding a node to the child.](/computer-science-curriculum-2020/go_left_then_right.png)
...
![In the image below, we go left twice.](/computer-science-curriculum-2020/go_left_twice.png)

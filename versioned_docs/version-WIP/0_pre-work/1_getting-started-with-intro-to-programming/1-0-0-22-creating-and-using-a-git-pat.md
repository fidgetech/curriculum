...
> **AI Support:** Stuck on a PAT or authentication error? After trying the steps in this lesson, you can ask AI to explain an error in plain language or suggest what to verify, such as whether your email is verified or your token has the right permissions — but never paste or ask AI to generate credentials. Before asking, check: [Do I have the license for this?](../../getting-started-at-fidgetech/1-0-0-13-using-ai-responsibly-at-fidgetech#activity-2-do-you-have-the-license-for-this) See [Using AI Responsibly at Fidgetech](../../getting-started-at-fidgetech/1-0-0-13-using-ai-responsibly-at-fidgetech) and [How to Ask for Help](../../getting-started-at-fidgetech/1-0-0-07-how-to-ask-for-help).

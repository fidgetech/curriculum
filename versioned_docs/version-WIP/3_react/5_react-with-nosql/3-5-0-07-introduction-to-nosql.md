---
title: "📓 3.5.0.7 Introduction to NoSQL"
day: weekend
id: 3-5-0-7-introduction-to-nosql
...
This is the biggest challenge for students coming from using SQL. They often want to know how to establish relationships between different records in a database. We will cover some basic ways to do this in the lesson [Structuring Data in Firestore](react/react-with-nosql/4-4-0-15-structuring-data-in-firestore), but this simply isn't a strength of NoSQL.

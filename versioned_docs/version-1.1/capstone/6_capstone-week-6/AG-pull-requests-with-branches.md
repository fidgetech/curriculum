---
title: "\U0001F4D3 Pull Requests with Branches"
...
(/Intermediate+JavaScript/making-pr-requests/click-on-pr-request-button.png)
...
(/Intermediate+JavaScript/making-pr-requests/add-a-comment-to-pr.png)
...
![See a list of pull requests in the repository.](/Intermediate+JavaScript/making-pr-requests/list-of-pull-requests.png)
...
![PR page gives us several options which we'll discuss below.](/Intermediate+JavaScript/making-pr-requests/merge-pull-request.png)
...
![We can click on the Delete Branch button to delete it.](/Intermediate+JavaScript/making-pr-requests/delete-branch.png)
...
![Message states we can't automatically merge.](/Intermediate+JavaScript/making-pr-requests/cant-automatically-merge.png)
...
![This branch has conflicts that must be resolved.](/Intermediate+JavaScript/making-pr-requests/click-resolve-conflicts.png)
...
![GitHub UI shows the merge conflict.](/Intermediate+JavaScript/making-pr-requests/resolve-merge-conflict.png)
...
![We can now click the commit merge button.](/Intermediate+JavaScript/making-pr-requests/resolved-conflict.png)

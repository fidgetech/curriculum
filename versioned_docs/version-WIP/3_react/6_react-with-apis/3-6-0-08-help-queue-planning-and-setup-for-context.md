---
title: "📓 3.6.0.8 Help Queue: Planning and Setup for Context"
day: weekend
id: 3-6-0-8-help-queue-planning-and-setup-for-context
...
As far as a state management tool, `useReducer()` is a fine alternative, and it depends on what you prefer and what you want to practice. To review the tradeoffs and benefits of the `useReducer()` hook, visit the lesson [The useReducer Hook](../../react/react-with-apis/4-5-0-4-the-usereducer-hook).

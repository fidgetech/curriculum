...
![Linear time increase is constant as the size of the data set increases.](/computer-science-curriculum-2020/linear_time_graph.png)
...
![Graph shows that over time, the light, fast rocket is not so fast.](/computer-science-curriculum-2020/o1_vs_oN_graph.png)
...
![The difference between O(n) and O(N<sup>2</sup>) on a graph.](/computer-science-curriculum-2020/on2_vs_on.png)

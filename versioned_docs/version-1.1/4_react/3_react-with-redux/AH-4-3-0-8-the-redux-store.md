---
title: "📓 4.3.0.8 The Redux Store"
day: weekend
id: 4-3-0-8-the-redux-store
...
* In order to actually log changes to state, we need to listen for changes with the `subscribe()` method. You may remember that we [briefly discussed the **pubsub** pattern](../../react/functional-programming-with-javascript/4-1-1-7-state) when we learned about functional programming. 

---
title: "\U0001F4D3 Git with Collaborators: Setup"
...
![GitHub repo settings](/git-with-teams/git-june-2020/click-on-settings-tab.png)

2. Go to `Manage Access` on the left side menu:

![Manage Access is in left-hand menu](/git-with-teams/git-june-2020/click-manage-access.png)

3. Click on `Invite Teams or People`: 

![Click "Invite Teams or People"](/git-with-teams/git-june-2020/click-invite-teams-or-people.png)
...
![Add the team member you want to add.](/git-with-teams/git-june-2020/add-gh-username-or-email.png)

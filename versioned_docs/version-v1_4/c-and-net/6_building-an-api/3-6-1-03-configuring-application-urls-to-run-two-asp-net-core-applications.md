---
title: "📓 5.6.1.3 Configuring Application URLs to Run Two ASP.NET Core Applications"
day: monday
id: 5-6-1-3-configuring-application-urls-to-run-two-asp-net-core-applications
